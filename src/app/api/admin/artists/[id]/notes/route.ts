// Admin notes endpoint for an artist.
// GET  -> list all Note records where entityType="artist" and entityId=id
// POST -> admin/agent posts a new note for this artist
...
export async function GET(
  ...
  const notes = await prisma.note.findMany({
    where: { entityType: "artist", entityId: id },
