  ...
  for (const a of demoArtists) {
    await prisma.artist.upsert({
      ...
      create: {
        ...
        scorePotential: a.scoring?.potential ?? 5,
        scoreLivePerformance: a.scoring?.livePerformance ?? 5,
        scoreMarketability: a.scoring?.marketability ?? 5,
        scoreReliability: a.scoring?.reliability ?? 5,
        scoreBookingPriority: a.scoring?.bookingPriority ?? 5,
        scoreOverall: a.scoring?.overall ?? 5,
